# 应该是目前最强的 PPT Agent：主帖清洗版

> 仅抽取原作者主帖，已移除论坛导航、回复、脚本和页面样式。提示词按原文保留；原文中不完整或疑似笔误之处未擅自修正。
...
![封面-1-设计稿 (1)](https://cdn3.ldstatic.com/original/4X/c/a/7/ca785958d37aba2c5e234af1f4d969945ae87b2f.jpeg)

![分层架构设计：从数据层到编排层-7-设计稿](https://cdn3.ldstatic.com/original/4X/2/b/9/2b9fbeb40ca978629c4986e994c2abc701f00121.jpeg)

![核心硬件：AIoT智能家居与人车家全生态闭环-8-设计稿](https://cdn3.ldstatic.com/original/4X/a/a/f/aaf137fb6a7a4ddff3c818a7c07cd5cb44562aea.jpeg)

可以搞定各种风格的设计：

![微信图片_20260317175828_1476_1](https://cdn3.ldstatic.com/original/4X/1/1/8/1181834e44162e2c873288ee999a8184e54380ad.jpeg)

![微信图片_20260317175833_1477_1](https://cdn3.ldstatic.com/original/4X/c/f/d/cfdbb2954d1b93ffc430c8a5652b3ef34f92dc5b.jpeg)

你可能会想，这不就是又一个AI PPT玩具吗？

不。你只需要给它一个主题，比如“Dify企业介绍”，然后就可以去泡杯咖啡了。它会像一个真正的专家团队那样，自己跑完从 需求调研 → 资料搜集 → 大纲策划 → 生成策划稿 → 生成设计稿 的全流程。

![3333](https://cdn3.ldstatic.com/original/4X/2/7/3/273349036183b47dd6873ff8a6fc4b7a269bc974.gif)

最后做出这样一套完整的设计：

![640 (5)](https://cdn3.ldstatic.com/original/4X/f/1/a/f1aab7cf304e037dc060a30e2f22555a06a83a24.gif)
...
![640 (3)](https://cdn3.ldstatic.com/original/4X/f/4/5/f45478b3c2c96c726e50d357f2b776f372267dfc.webp)
...
![1](https://cdn3.ldstatic.com/original/4X/1/c/e/1cec102727d58958c25d6da46a1955e063b95199.gif)
...
![640 (4)](https://cdn3.ldstatic.com/original/4X/6/2/a/62a898a2d1178c85985ece017fc7ec2f166280c4.webp)

但如果你想自己DIY这个流程，我墙裂推荐一个神器： Grok 。

别的不说，它是我目前用过搜索和信息总结能力最强的AI，没有之一。用法简单到发指：把上一步生成的大纲标题，一个一个丢给Grok，它就能帮你把所需资料搜集、整理得妥妥帖帖。

![ScreenShot_2026-03-19_104103_358](https://cdn3.ldstatic.com/original/4X/6/3/0/6305c980802f3a1ddff840e44a71c842a9d9ea88.png)
...
![640 (5)](https://cdn3.ldstatic.com/original/4X/6/b/f/6bffcac7dd291641b6cdfa71cce3538a58248974.webp)

他们最终会提供一个PPT草稿给到设计师，每页什么位置要放什么元素，用什么样的版式，全都固定好。

就像这样：

![640 (7)](https://cdn3.ldstatic.com/original/4X/b/6/3/b6318bdc47fbfd9d7466fdbb944ad839d6154158.webp)

真正让AI去做PPT的时候，你也可以试试一样的处理。先让AI生成一个，不要各种复杂效果，简简单单，清清爽爽的页面初稿。

![640 (6)](https://cdn3.ldstatic.com/original/4X/5/1/9/519bbc1c6824983966ca86882578e0c752288d66.webp)

到后面再去加设计的效果：

![640 (8)](https://cdn3.ldstatic.com/original/4X/b/c/8/bc840a42bada631399f6d5c0504b9b11990210a7.webp)
...
![640 (9)](https://cdn3.ldstatic.com/original/4X/2/8/d/28d75c58237d2ea179ddd772da651aae0ac455ce.webp)

之前在论坛发了两篇文章，用的也是一样的卡片式布局的思路。

> 关联文章：把小米379页的年报转为可视化网页，附完整提示词 开发调优

![640 (10)](https://cdn3.ldstatic.com/original/4X/c/7/a/c7a44935dcb61e2bc0421e6e8b2a35343a044806.webp)
...
![ScreenShot_2026-03-19_104134_376](https://cdn3.ldstatic.com/original/4X/c/7/4/c74bd996a229c7abf44d1ad0a6ff9d1dd37d78bc.png)

它直接就能生成这样一整个页面的SVG代码了：

![ScreenShot_2026-03-19_103904_044](https://cdn3.ldstatic.com/original/4X/2/6/f/26f3fcb9890f2b0727180c9ef98a18cc01900137.jpeg)
